    ...
    public class Calls : MelonMod
    {
            ...
            if (sceneChanged)
            {
                try
                {
                    ...
                    else if ((currentScene == "Gym") && (!mapInit))
                    {
                        ...
                        allBaseGymGameObjects.Add(GameObject.Find("VoiceLogger"));
                    ...
                    else if ((currentScene == "Park") && (!mapInit))
                    {
                        ...
                        parkSpawnPointHandler = GameObjects.Park.Logic.SpawnPointHandler.GetGameObject().GetComponent<SpawnPointHandler>();
        ...
        public class GameObjects
        {
            public class DDOL
            {
                ...
                public class GameInstance
                {
                    ...
                    public class PreInitializable
                    {
                        ...
                        public class PoolManager
                        {
                            ...
                            public class ADustBreakDISCVFX
                            {
                ...
                {
                    public static GameObject GetGameObject() { return allBaseDDOLGameObjects[5]; }
                }

                public class AnalyticsContainer
                {
                    public static GameObject GetGameObject() { return allBaseDDOLGameObjects[6]; }
                }

                public class PlayFabHttp
                {
                    public static GameObject GetGameObject() { return allBaseDDOLGameObjects[7]; }
                }
            }
            ...
            public class Gym
            {
                ...
                public class Scene
                {
                    public static GameObject GetGameObject() { return allBaseGymGameObjects[4]; }
                    ...
                    public class GymProduction
                    {
                        ...
                        public class SubStaticGroupBuildings
                        {
                            ...
                            public class School
                            {
                                ...
                                {
                                    public static GameObject GetGameObject() { return School.GetGameObject().transform.GetChild(6).gameObject; }
                                }
                            }
                        }
                ...
                {
                    public static GameObject GetGameObject() { return allBaseGymGameObjects[5]; }
                ...
                public class SteamAudioManagerSettings
                {
                    public static GameObject GetGameObject() { return allBaseGymGameObjects[6]; }
                }

                public class Logic
                {
                    public static GameObject GetGameObject() { return allBaseGymGameObjects[7]; }
                    ...
                    public class HeinhouserProducts
                    {
                        ...
                        public class MailTube
                        {
                            ...
                            {
                                public static GameObject GetGameObject() { return MailTube.GetGameObject().transform.GetChild(0).gameObject; }
                            }

                            public class ShootVFX
                            {
                                public static GameObject GetGameObject() { return MailTube.GetGameObject().transform.GetChild(1).gameObject; }
                            }

                            public class Mesh
                            {
                                public static GameObject GetGameObject() { return MailTube.GetGameObject().transform.GetChild(2).gameObject; }
                                ...
                                public class Glass
                                {
                                    public static GameObject GetGameObject() { return Mesh.GetGameObject().transform.GetChild(3).gameObject; }
                                }

                                public class Lid
                                {
                                    public static GameObject GetGameObject() { return Mesh.GetGameObject().transform.GetChild(4).gameObject; }
                                }

                                public class InfoFormCanvas
                                {
                                    public static GameObject GetGameObject() { return Mesh.GetGameObject().transform.GetChild(5).gameObject; }
                                ...
                                {
                                    public static GameObject GetGameObject() { return Mesh.GetGameObject().transform.GetChild(6).gameObject; }

                                    public class SliderHandle
                                    {
                                        public static GameObject GetGameObject() { return ReferenceTransform.GetGameObject().transform.GetChild(0).gameObject; }
                                        ...
                                        {
                                            public static GameObject GetGameObject() { return SliderHandle.GetGameObject().transform.GetChild(1).gameObject; }
                                        }
                                    }
                                }
                            }
                            ...
                            {
                                public static GameObject GetGameObject() { return MailTube.GetGameObject().transform.GetChild(3).gameObject; }
                            }
                        }
                        ...
                        public class ShiftstoneCabinet
                        {
                            ...
                            public class Cabinet
                            {
                                ...
                                public class ShiftstoneBox01
                                {
                                    ...
                                    public class GuardStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox01.GetGameObject().transform.GetChild(3).gameObject; }
                                ...
                                public class ShiftstoneBox02
                                {
                                    ...
                                    public class FlowStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox02.GetGameObject().transform.GetChild(3).gameObject; }
                                    ...
                                    public class FlowStone_
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox02.GetGameObject().transform.GetChild(4).gameObject; }

                                        public class Mesh
                                        {
                                            public static GameObject GetGameObject() { return FlowStone_.GetGameObject().transform.GetChild(0).gameObject; }
                                        }

                                        public class ShiftstoneTriggerVFX
                                        {
                                            public static GameObject GetGameObject() { return FlowStone_.GetGameObject().transform.GetChild(1).gameObject; }
                                        }
                                    }
                                }
                                ...
                                public class ShiftstoneBox03
                                {
                                    ...
                                    public class StubbornStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox03.GetGameObject().transform.GetChild(3).gameObject; }
                                ...
                                public class ShiftstoneBox04
                                {
                                    ...
                                    public class ChargeStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox04.GetGameObject().transform.GetChild(3).gameObject; }
                                ...
                                public class ShiftstoneBox05
                                {
                                    ...
                                    public class VolatileStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox05.GetGameObject().transform.GetChild(3).gameObject; }
                                    ...
                                    public class VolatileStone_
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox05.GetGameObject().transform.GetChild(4).gameObject; }

                                        public class Mesh
                                        {
                                            public static GameObject GetGameObject() { return VolatileStone_.GetGameObject().transform.GetChild(0).gameObject; }
                                        }

                                        public class ShiftstoneTriggerVFX
                                        {
                                            public static GameObject GetGameObject() { return VolatileStone_.GetGameObject().transform.GetChild(1).gameObject; }
                                        }
                                    }
                                }
                                ...
                                public class ShiftstoneBox06
                                {
                                    ...
                                    public class CounterStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox06.GetGameObject().transform.GetChild(3).gameObject; }

                                        public class Mesh
                                        {
                                            public static GameObject GetGameObject() { return CounterStone.GetGameObject().transform.GetChild(0).gameObject; }
                                        }

                                        public class ShiftstoneTriggerVFX
                                        {
                                            public static GameObject GetGameObject() { return CounterStone.GetGameObject().transform.GetChild(1).gameObject; }
                                        }
                                    }
                                ...
                                public class ShiftstoneBox07
                                {
                                    ...
                                    public class UnyieldingStone
                                    {
                                        public static GameObject GetGameObject() { return ShiftstoneBox07.GetGameObject().transform.GetChild(3).gameObject; }

                                        public class Mesh
                                        {
                                            public static GameObject GetGameObject() { return UnyieldingStone.GetGameObject().transform.GetChild(0).gameObject; }
                                        }

                                        public class ShiftstoneTriggerVFX
                                        {
                                            public static GameObject GetGameObject() { return UnyieldingStone.GetGameObject().transform.GetChild(1).gameObject; }
                                        }
                                    }
                        ...
                        {
                            public static GameObject GetGameObject() { return HeinhouserProducts.GetGameObject().transform.GetChild(14).gameObject; }
        ...
        public class Managers
        {
            ...
            public static SteamAudioManager GetSteamAudioManager() { return steamAudioManager; }
        ...
        public class Gym
        {
            ...
            public static SpawnPointHandler GetGymSpawnPointHandler() { return gymSpawnPointHandler; }

            public static MatchmakingHandler GetGymMatchmakingHandler() { return matchmakingHandler; }

            public static RewardHandler GetGymRewardHandler() { return rewardHandler; }
        }

        public class Park
        {
            public static SpawnPointHandler GetParkSpawnPointHandler() { return parkSpawnPointHandler; }
        ...
        public class Pools
        {
            ...
            public class Structures
            {
                public static GameObject GetPoolDisc() { return poolManager.transform.GetChild(43).gameObject; }

                public static GameObject GetPoolPillar() { return poolManager.transform.GetChild(42).gameObject; }

                public static GameObject GetPoolBall() { return poolManager.transform.GetChild(51).gameObject; }

                public static GameObject GetPoolCube() { return poolManager.transform.GetChild(50).gameObject; }

                public static GameObject GetPoolWall() { return poolManager.transform.GetChild(49).gameObject; }

                public static GameObject GetPoolSmallRock() { return poolManager.transform.GetChild(16).gameObject; }

                public static GameObject GetPoolLargeRock() { return poolManager.transform.GetChild(17).gameObject; }

                public static GameObject GetPoolBoulderBall() { return poolManager.transform.GetChild(1).gameObject; }
            }

            public class ShiftStones
            {
                public static GameObject GetPoolVolatileStone() { return poolManager.transform.GetChild(3).gameObject; }

                public static GameObject GetPoolChargeStone() { return poolManager.transform.GetChild(4).gameObject; }

                public static GameObject GetPoolSurgeStone() { return poolManager.transform.GetChild(5).gameObject; }

                public static GameObject GetPoolFlowStone() { return poolManager.transform.GetChild(6).gameObject; }

                public static GameObject GetPoolGuardStone() { return poolManager.transform.GetChild(7).gameObject; }

                public static GameObject GetPoolStubbornStone() { return poolManager.transform.GetChild(8).gameObject; }

                public static GameObject GetPoolAdamantStone() { return poolManager.transform.GetChild(9).gameObject; }

                public static GameObject GetPoolVigorStone() { return poolManager.transform.GetChild(10).gameObject; }
            }
        }
        ...
        public class Players
        {
            ...
            public static Player GetLocalPlayer() { return playerManager.localPlayer; }
            ...
            public static Player GetClosestPlayer(UnityEngine.Vector3 pos, bool ignoreLocalController) { return playerManager.GetClosestPlayer(pos, ignoreLocalController); }
